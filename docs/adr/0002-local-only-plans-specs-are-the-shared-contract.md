...
- super-exec adds `.super-exec/` to `.gitignore`. The plan must be self-contained enough to survive the session boundary and a handoff/resume without the controller's prior context.
