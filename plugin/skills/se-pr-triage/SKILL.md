...
- [ ] **4. Triage Track A items**
- [ ] **5. Mandatory batch approval gate (Track A only)**
- [ ] **6. Execute Track A after approval**
- [ ] **7. Execute Track B (autonomous)**
- [ ] **8. End-of-round report**
- [ ] **9. Clear `.super-exec/active`**
...
| "The draft is obvious, so approval can happen after." | Post a reply or push code for a Track A item before the human has approved the batch. | Write the draft, present the full batch, wait for approval. This rule has no exceptions. |
