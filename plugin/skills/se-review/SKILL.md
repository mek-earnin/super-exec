...
Dispatch a fresh reviewer subagent (strong / reviewer tier) using the `Task` tool. See the `se-subagent` skill for prose tier aliases and dispatch guidance. Provide the reviewer with:
